...
<div class="production-content">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3 jc-c">
                <div class="dropdown">
                    <button class="inner-btn third-btn" type="button" data-toggle="dropdown">
                        <? if(isset($_SESSION['sub_category_id'])):?><?=$current_sub_category->getName();?><?endif;?>
                        <? if(!isset($_SESSION['sub_category_id'])):?><?=Yii::$app->view->params['translation'][26]->text;?><?endif;?>
                    </button>
                    <ul class="dropdown-menu">
                        <? if($subCategory != null):?>
            ...
            <div class="col-sm-12 col-md-3 jc-c">
                <input class="search" type="search" placeholder="<?=Yii::$app->view->params['translation'][0]->text;?>" value="<?= $_SESSION['text'];?>">
            </div>
        </div>
    </div>
