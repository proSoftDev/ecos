...
<body>
	<div class="services">
				...
				<div class="col-sm-12 col-md">
					<nav class="menu" id="main-nav">
						<ul>
							...
							<li class="acting"><a href="services.php">услуги</a></li>
		...
		<div class="container mt-5 mb-5">
			<div class="row">
				<div class="col-sm-12 col-md">
					<p class="main-plink"><a href="index.php">Главная </a><span>/ </span><a href="services.php">Услуги </a><span>/ </span>Услуга</p>
				</div>
			</div>
		</div>
	<div class="services-content">
		<div class="container">
			<div class="row mt-5 mb-4">
				<div class="col-sm-12 col-md">
					<h2 class="services-h2">Услуга</h2>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-4 text-center">
					<img src="images/services.png" class="mb-3">
				</div>
