...
<div class="faq-form" style="padding-bottom: 1500px;">
    ...
    <div class="col-md-12 pl-0 pr-0">
        ...
        <div id="myTabContent" class="tab-content bg-white box-shadow p-4 mb-4">
            ...
            <div id="en" role="tabpanel" aria-labelledby="en-tab" class="tab-pane fade">
                ...
                <?php
                echo $form->field($model, 'answer_en')->widget(CKEditor::className(),[
                    'editorOptions' => [
            ...
            <div id="kz" role="tabpanel" aria-labelledby="kz-tab" class="tab-pane fade">
                ...
                <?= $form->field($model, 'question_kz')->textInput() ?>


                <?php
                echo $form->field($model, 'answer_kz')->widget(CKEditor::className(),[
                    'editorOptions' => [
                        'preset' => 'full', // basic, standard, full
                        'inline' => false, //по умолчанию false
                    ],
